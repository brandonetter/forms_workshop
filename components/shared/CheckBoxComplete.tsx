...
const CheckBox = forwardRef<HTMLInputElement, CheckBoxProps>(function CheckBox ({value,category,children,...rest},ref){
    ...
    return (
        ...
        <input {...rest} type="checkbox" className="peer hidden" id={id}  value={value} ref={ref}/>
